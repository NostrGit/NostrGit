      ...
      <div className="lg:flex justify-between gap-4 px-4 sm:px-0">
        <div className="isolate inline-flex rounded-md text-sm lg:text-base shadow-sm w-full mb-4 lg:mb-0">
          ...
          <button
            type="button"
            className={clsx(
              "hidden relative md:block -ml-px w-full rounded-r-md py-1.5 font-semibold text-zinc-300 ring-1 ring-inset ring-gray focus:z-10",
              {
                "bg-purple-600 text-zinc-50": issueType === `request`,
              }
            )}
